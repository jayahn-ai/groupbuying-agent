# Groupbuying Agent                                                                                                                             
  ...
  인플루언서 공동구매 마케팅 업무를 자동화하는 AI 에이전트.                                                                                       
  자연어 질문 하나로 인게이지먼트 분석, 수익 시뮬레이션, 정산 계산, 정산 메일 발송, 지식 Q&A를 처리합니다.
  ...
  **[→ 라이브 데모](https://jayahn-ai.github.io/groupbuying-agent/)**                                                                             
  ...
  3. **골든 데이터셋 (4/25)** — 인텐트별 이상 Q&A 32쌍 수집 → 답변 형식·수치 포함 기준 확정                                                       
  ...
  | [`architecture_memo.md`](./architecture_memo.md) | 도구 선택 이유, 데이터 흐름, 예상 비용 (~$10/월) |                                         
